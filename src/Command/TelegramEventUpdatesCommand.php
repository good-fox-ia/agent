...
{
    public function __construct(private readonly TelegramService $telegram, private readonly MessageBusInterface $bus)
    {
        parent::__construct();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        while (true) {
            ...
            foreach ($updates as $update) {
                ...
                if (!is_array($message) && !isset($message['chat']['id'])) continue;
